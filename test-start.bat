...
java %LOGGING% %HTTP_DEBUG% %COVERAGE_MANAGER% %OTEL% -jar sl-test-listener.jar start -buildsessionidfile buildSessionId.txt -tokenfile dev-integ-ftv2.token.txt -labid %SL_LAB_ID% -testStage "Runner Stage"
